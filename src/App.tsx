  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-emerald-900 via-emerald-800 to-emerald-900 text-white">
      ...
      <main className="max-w-4xl mx-auto px-4 py-6 space-y-6">
        ...
        {/* Footer */}
<footer className="text-center text-xs text-emerald-300/80 py-6 mt-2">
  ...
  <p className="mt-1">
    ...
    <a
      ...
      className="hover:text-white transition-colors duration-200 underline decoration-emerald-500/50"
    >
      github
    </a>
  </p>
